...
import { updateCategory,getCategoryById } from '@/services/categories.services';

interface EditCategorySideSheetProps {
    categoryId: number;
    isShown: boolean;
    onClose: () => void;
}

const EditCategorySideSheet: FC<EditCategorySideSheetProps> = ({ isShown, onClose, categoryId }) => {
    ...
    const categoryMutation = useMutation({
        ...
        onSuccess() {
            ...
            notify({
                type: "success",
                title: "Categorie edited successfully",
                message: "Categorie edited successfully"
            })
        },
        onError: (error: any) => {
            console.log(error);
    ...
    const handleSubmit = () => {
        const { parent: _, ...customCategoryData } = categoryData
       categoryMutation.mutate({ id: categoryId, updatData: customCategoryData });
    };
...
export default EditCategorySideSheet;